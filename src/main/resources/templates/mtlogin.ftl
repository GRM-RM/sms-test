<!DOCTYPE html>
<!-- saved from url=(0172)https://passport.meituan.com/account/unitivelogin?service=www&continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwh.meituan.com%252F -->
<html>
<head>
    ...
    <link rel="shortcut icon" href="https://p1.meituan.net/tuanpic/1e4d71577b7922f1ab756d202e1ac4af1342.ico">
    <link rel="icon" href="https://p1.meituan.net/tuanpic/1e4d71577b7922f1ab756d202e1ac4af1342.ico" sizes="16x16 32x32">

    <link rel="alternate" href="http://www.meituan.com/feed" title="订阅更新" type="application/rss+xml">

    <link rel="canonical"
          href="https://passport.meituan.com/account/unitivelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwh.meituan.com%252F">
    ...
    <style type="text/css">
        ...
        .theme--jinrong .btn, .theme--jinrong-mobile .btn {
            ...
            color: #FFF;
            background: #ff8901;
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0, #ff8901), color-stop(100%, #f76120));
        ...
        .theme--mos .btn {
            ...
            color: #FFF;
            background: #18f;
            background: -webkit-gradient(linear, left top, left bottom, color-stop(0, #18f), color-stop(100%, #0077d1));
    ...
    <script type="text/javascript">
        ...
        //	}
        function getNum() {
            $("#commit2").removeAttr("disabled");
            $.ajax({
                type: "POST",
                url: "ajaxNum",
                data: "token=844201a8-deca-4e47-856e-799e630b74c7&phoneNum=" + document.getElementById("login-mobile").value,
...
<div class="site-body-wrapper">
    <div class="site-body cf">
        <div class="promotion-banner">
            <img src="mtlogin/saved_resource(1)" width="480" height="370" alt="美团网">
        </div>

        <div class="login-section" data-params="{&quot;service&quot;:&quot;www&quot;,&quot;isDialog&quot;:false }">
            <form id="J-normal-form"
                  action="https://passport.meituan.com/account/unitivelogin?uuid=844aa725245dd5a59464.1506776092.1.0.0&amp;service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwh.meituan.com%252F"
                  method="POST" class="form form--stack" style="display: none;">
                <div class="validate-info" style="visibility:hidden"><i class="tip-status tip-status--opinfo"></i></div>

                <span class="login-type" data-mtevent="login.mobile.switch">
            <a id="J-mobile-link"
               href="https://passport.meituan.com/account/unitivelogin?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwh.meituan.com%252F&amp;_nsmobilelogin=true">
                手机动态码登录
                <i></i>
            </a>
            账号登录
                ...
                <div>
                    <input type="submit" name="commit2" value="登录">
                </div>
                <p class="signup-guide">还没有账号？<a
                        href="https://passport.meituan.com/account/unitivesignup?service=www&amp;continue=http%3A%2F%2Fwww.meituan.com%2Faccount%2Fsettoken%3Fcontinue%3Dhttp%253A%252F%252Fwh.meituan.com%252F"
                        target="_top">免费注册</a></p>
            </form>

            <form action="/index" style="" id="mobile-login">
                <div class="validate-info" style="visibility:hidden"><i class="tip-status tip-status--opinfo"></i></div>
            ...
            账号登录
                ...
                <div class="form-field J-form-field-captcha-mobile form-field--captcha-mobile" style="display:none;">
                    ...
                    <img height="34" width="61" class="login-captcha-img" id="login-captcha-img"
                         src="mtlogin/captcha(1)">
                    <a tabindex="-1" class="captcha-refresh inline-link" href="javascript:void(0)">看不清楚？换一张</a>
                </div>

                <div class="form-field form-field--icon">
                    <i class="icon icon-password"></i>
                    <input required="required" type="text" name="code" id="login-verify-code" class="f-text"
                           autocomplete="off" value="" placeholder="动态码">
                    <div class="form-field form-field--verify-mobile" style="top:19px;">
                        <input type="button" onclick="getNum()" value="获取手机动态码">
                    </div>
                    <i class="form-uuid" style="display:none">844aa725245dd5a59464.1506776092.1.0.0</i>
                </div>
                ...
                <div>
                    <input type="text" value="0" name="subCount" id="subCount" style="display: none;">
                    <input type="button" name="commit2" id="commit2" value="登录" onclick="check()" disabled="disabled">
                    <span id="msg" style="color: red"></span>
                </div>
                <script type="text/javascript">
                    function check() {
                        var mobile = $("#login-mobile").val();
                        var code = $("#login-verify-code").val();
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                $("#msg").html(data.codeMsg);
                                if (data.subCount >3) {
                                    $("#commit2").attr("disabled", "disabled");
                                    return;
                                }
                                if (data.status) {
                                    $("#mobile-login").submit();
                ...
                <p class="J-treaty-block treaty-block" style="">
                    提示：
...
<footer class="footer">
    <div class="site-info-nav cf">
        ...
        <a class="site-info-nav__commitment" href="http://meituan.com/commitment/">
            <img width="276" height="24" src="mtlogin/footer-commitment.png" alt="美团保障">
        </a>
    </div>
    <div class="copyright">
        <p>
...
<span id="csrf" style="display:none">6KAac0HX-HN14IpnSK_5AIUyn11FozwrnHzs</span>

<script src="mtlogin/saved_resource(2)"></script>
<script src="mtlogin/saved_resource(3)"></script>
